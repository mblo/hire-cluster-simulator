...
CMD='python3 src/main/python/ExpRunner.py --jar target/hire.jar --memory 30 --worker 15 --output exp-rerun-asplos-baselines-k8 --set
cell-k=26
...
scheduler=kubernetes#,greedy:kubernetes,resubmit,-10
