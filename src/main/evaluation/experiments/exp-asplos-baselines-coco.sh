...
CMD='python3 src/main/python/ExpRunner.py --jar target/hire.jar --memory 30 --worker 15 --output exp-rerun-asplos-baselines-coco --set
cell-k=26
...
scheduler=coco,parallel-0-relax-cost-ssp,resubmit,-10
