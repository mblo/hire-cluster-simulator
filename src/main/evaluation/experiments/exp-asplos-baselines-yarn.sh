...
CMD='python3 src/main/python/ExpRunner.py --jar target/hire.jar --memory 30 --worker 15 --output exp-rerun-asplos-baselines-yarn --set
cell-k=26
...
scheduler=yarn#,greedy:yarn,resubmit,-10
